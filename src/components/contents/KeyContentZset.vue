      ...
      <vxe-table
        ...
        <vxe-column title="Operate" width="166">
          ...
          <template slot-scope="scope">
            <el-button class="key-row-action" type="text" @click="$util.copyToClipboard(scope.row.member)" icon="el-icon-document" :title="$t('message.copy')"></el-button>
            <el-button class="key-row-action" type="text" @click="showEditDialog(scope.row)" icon="el-icon-edit" :title="$t('message.edit_line')"></el-button>
